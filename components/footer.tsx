        ...
        <div>
          ...
          <div className="footer-links mobile-footer-links">
            ...
            <div className="footer-link-group">
              <div className="aqua-navigation">
                 <ul className="nav">
                  <li className="nav-privacy-policy"><a href="https://aqua.net/privacy-web/">{t('nav_privacy_policy')}</a></li>
                  <li className="nav-terms-and-conditions"><a href="https://aqua.net/terms-web/">{t('nav_terms_and_conditions')}</a></li>
              </ul>
              </div>
            </div>
            <div className="footer-link-group">
